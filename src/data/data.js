...
const buildAllProducts = () => {
  const rawList = [
    ...
    { id: 27, name: 'Portable Bluetooth Speaker Waterproof Outdoor', price: 39.99, oldPrice: 49.99, discount: 20, rating: 4.7, reviewCount: 892, image: `${ASSETS_BASE}/71cHiwCmk+L._AC_SL400_.jpg` },
    { id: 28, name: 'Wireless Earbuds Bluetooth 5.3 Headphones Noise Cancelling', price: 24.99, oldPrice: 34.99, discount: 29, rating: 4.4, reviewCount: 1560, image: `${ASSETS_BASE}/81BqfCWvzxL._AC_SL400_.jpg` },
