...
// then places wholesale orders against whatever a seller has stocked. Beyond the
// hand-curated starter list below, every product sold on the storefront (imported from
// the live catalogue in importedProducts.js — ~4,900 items across 20 categories) is also
// added to the catalog, so a seller can stock essentially anything a customer can buy.
