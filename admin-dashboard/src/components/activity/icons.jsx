// The small outline icons of the activity pages (Recent Actions, My Logs).
const PATHS = {
  ...
  arrowUpRight: 'M7 17L17 7M17 7H8m9 0v9',
...
export const Icon = ({ name, className = 'h-5 w-5', strokeWidth = 1.8 }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d={PATHS[name] || PATHS.pulse} />
  </svg>
)

// A filled map pin (where a sign-in came from).
export const PinIcon = ({ className = 'h-4 w-4 text-rose-500' }) => (
